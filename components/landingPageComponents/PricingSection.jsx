            ...
            <div className='bg-[#0077B6] h-[674] lg:w-[402px] w-[300px] rounded-md py-[35px] lg:px-[68px]'>
                <div className='flex justify-center'>
                    <div className='flex flex-col items-center'>
                        ...
                        <button className='bg-[#FFFFFF] lg:text-lg text-sm  rounded-md lg:px-[32px] px-[16px] lg:py-[16px] py-[10px] my-[26px] text-[#0077B6]'>Get started</button>
                    </div>
                </div>
            </div>

            <div className='relative lg:hidden left-[50.5%] top-[55px]'>
                {springSVG}
            </div>
            <div className='border border-[#0077B6] bg-[#FFFFFF] h-[674] lg:w-[402px] w-[300px] rounded-md py-[35px] lg:px-[68px] text-black'>
                <div className='flex justify-center'>
                    <div className='flex flex-col items-center'>
                        <h2 className='lg:text-4xl text-2xl font-bold mb-[16px]'>Standard</h2>
                        <p className='text-sm'>Annual Payment</p>
                        <p className='lg:text-5xl text-3xl font-bold my-[26px]'>$25</p>
                        <center>
                            <p className='mb-[5px] lg:text-sm text-xs w-[267px] '>Based on monthly Request</p>
                            <input type="range" min='500' name='priceRange' value={priceRange} max='2000' onChange={handleChange} className='border h-3 w-[211px] bg-[#0077B6]' />
                            <div className='flex justify-between w-[211px] lg:text-sm text-xs'>
                                <span>500</span>
                                <span>2000</span>
                            </div>
                        </center>
                        ...
                        <button className='text-[#FFFFFF] lg:text-lg text-sm rounded-md lg:px-[32px] px-[16px] lg:py-[16px] py-[10px] my-[26px] bg-[#0077B6]'>Get started</button>
                    </div>
                </div>
            </div>
            <span className='relative hidden lg:block  right-[8.5%] pb-[653px]'>
                {springSVG}
            </span>
        </div>
    )
