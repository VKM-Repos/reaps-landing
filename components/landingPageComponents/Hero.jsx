...
export default function Hero() {
  return (
    <div className='h-screen w-screen bg-[#ffffff] flex items-center sm:pl-[75px] px-12 pr-[50px] pt-24   sm:pt-20'>
        <div className='sm:w-2/3 w-full px-3 -mt-[100px]'>
            <p className='font-bold text-4xl lg:text-7xl  '>
            <span className='flex flex-col'>Your  ethics approval
                <svg className=' relative left-[22%]  lg:top-[20%] w-[120px] lg:w-[232px] lg:h-[11px]'   viewBox="0 0 232 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                 ...
                 made easy.</p>
            <p className='py-10 sm:text-lg text-sm tracking-wide leading-8 text-gray-500 lg:w-[690px]  '>
