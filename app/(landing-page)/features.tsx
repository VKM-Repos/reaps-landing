...
export function Features() {
  return (
    <section className="relative flex min-h-full w-full items-center justify-center overflow-hidden bg-white py-[8rem]">
      <svg
      ...
      <div className="mx-auto flex w-[85%] flex-col  items-start justify-start gap-16">
        ...
        <div className="flex flex-wrap items-center justify-center gap-5">
          {features_data?.map((feature) => (
            <div
              key={feature.id}
              className="bg-accent flex min-h-[20rem] w-full max-w-sm flex-col items-start justify-start gap-5 rounded-xl border border-[#8A6A00] p-4 md:w-1/2 lg:w-1/3"
            >
